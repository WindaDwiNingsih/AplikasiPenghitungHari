...
public class PenghitungHari extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        selisih = new javax.swing.JTextPane();
        ...
        jPanel1.setBackground(new java.awt.Color(250, 233, 233));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Aplikasi Penghitung Hari", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18))); // NOI18N
        ...
        jLabel7.setText("Kabisat");

        selisih.setBorder(javax.swing.BorderFactory.createTitledBorder("Selisih Hari"));
        jScrollPane1.setViewportView(selisih);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jCalendarComboBox1, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jLabel8)
                        .addGap(26, 26, 26)
                        .addComponent(jCalendarComboBox2, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    int bulan = jComboBox1.getSelectedIndex() + 1; // Bulan dimulai dari 0
    // Mendapatkan tanggal dari JDateChooser
    
                LocalDate date1 = jCalendarComboBox1.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
                LocalDate date2 = jCalendarComboBox2.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate();

                // Menghitung selisih hari
                long daysBetween = ChronoUnit.DAYS.between(date1, date2);
                selisih.setText("" + daysBetween);
                
    // Menghitung jumlah hari dalam bulan
    YearMonth yearMonth = YearMonth.of(tahun, bulan);
    int jumlahHari = yearMonth.lengthOfMonth();
    
    jTextField1.setText(""+ jumlahHari); 
    
    LocalDate pertama = LocalDate.of(tahun, bulan, 1);
    LocalDate terakhir = LocalDate.of(tahun, bulan, jumlahHari);
    LocalDate tanggal = LocalDate.of(tahun, 2, 1);  
    
    jTextField2.setText("" + pertama.getDayOfWeek());
    jTextField3.setText("" + terakhir.getDayOfWeek());
    if (tanggal.isLeapYear()){
        jTextField4.setText("Tahun Kabisat");
    }else{
        jTextField4.setText("Bukan Tahun Kabisat");
    }
...
// TODO add your handling code here:
    ...
    private javax.swing.JTextPane selisih;
